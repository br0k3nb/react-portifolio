            ...
            {projects.map((project, idx) => {
              return (
                  <motion.div
                    ...
                    className={`w-full xxs:!w-[85%] sm:w-[90%] md:w-1/2 xl:w-[32%] p-7 xxs:py-7 xxs:px-0 xxs:mx-auto`}
                  >
                      <div className={`block shadow-2xl shadow-teal-900/30 hover:shadow-teal-800/100 bg-stone-800 hover:shadow-xl rounded-2xl overflow-hidden `}>
                          ...
                          {project.underConstruction ? (
                            <div className="absolute inset-0">
                              <div className="relative flex items-center">
                                <div className='z-10 absolute w-full bg-teal-600/90 flex flex-row justify-evenly xxs:justify-center rounded-sm shadow-2xl shadow-slate-900 top-24'>
                        ...
                        <div className="p-4">
                          <div className="px-2">
                            <h2 className="mt-2 mb-4 font-thin text-3xl">{project.name}</h2>
                          ...
                          <div className="px-2">
                            ...
                            <div className="flex flex-row align-bottom space-x-4 mb-2">
                              ...
                              >
                                <BsGithub
                                  size={30}
                                  className={`hover:-translate-y-1 transition-transform cursor-pointer ${project.link === '' && 'cursor-not-allowed hover:translate-y-0'}`}
                                />
                              </a>
                              <a 
                                draggable={false}
