                    ...
                    >
                        ...
                        <div className="flex flex-row justify-between space-x-2">
                            ...
                            {showCloseTooltip ? (
                                ...
                                <label 
                                    htmlFor="my-modal-3"
                                    className={`transition-all duration-300 ease-in-out bg-[#ffffff] border border-gray-500 text-gray-900 dark:text-gray-300 btn btn-sm btn-circle bg-inherit hover:bg-[#eeeff1] dark:hover:!bg-[#323232] dark:hover:border-gray-500 pb-[1px] ${closeButtonClassName && closeButtonClassName}`}
                                    onClick={() => onClose ? onClose() : setOpen && setOpen(false)}
                                >
                                    <AiOutlineClose size={16} className="my-[7px]"/>
                                </label>
